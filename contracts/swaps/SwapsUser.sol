...
contract SwapsUser is State, SwapsEvents, FeesHelper {
	...
	function _swapsExpectedReturn(
		...
		uint256 sourceToDestRate = ISwapsImpl(swapsImpl).internalExpectedRate(sourceToken, destToken, sourceTokenAmount);
		uint256 sourceToDestPrecision = IPriceFeeds(priceFeeds).queryPrecision(sourceToken, destToken);
